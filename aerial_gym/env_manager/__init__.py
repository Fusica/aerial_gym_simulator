...
from aerial_gym.config.env_config.pursuit_guidance_env import PursuitGuidanceEnvCfg
...
env_config_registry.register("pursuit_guidance_env", PursuitGuidanceEnvCfg)
